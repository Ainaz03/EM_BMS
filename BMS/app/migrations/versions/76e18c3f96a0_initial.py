...
Revision ID: 76e18c3f96a0
Revises: 
Create Date: 2025-06-09 23:02:14.610509
...
def upgrade() -> None:
    ...
    # Сначала создаём таблицу users (независимая)
    ...
    op.create_table('teams',
        ...
        sa.Column('admin_id', sa.Integer(), nullable=False, comment='ID пользователя — администратора команды'),
    ...
    # Теперь добавляем внешний ключ users.team_id → teams.id
    ...
    op.create_table('meetings',
        ...
        sa.Column('start_time', sa.DateTime(), nullable=False, comment='Дата и время начала встречи'),
        sa.Column('end_time', sa.DateTime(), nullable=False, comment='Дата и время окончания встречи'),
        sa.Column('creator_id', sa.Integer(), nullable=False, comment='ID пользователя, создавшего встречу'),
    ...
    op.create_table('tasks',
        ...
        sa.Column('created_at', sa.DateTime(), nullable=False, comment='Дата и время создания задачи'),
        sa.Column('deadline', sa.DateTime(), nullable=True, comment='Срок выполнения задачи'),
        sa.Column('creator_id', sa.Integer(), nullable=False, comment='ID пользователя, создавшего задачу'),
        sa.Column('assignee_id', sa.Integer(), nullable=False, comment='ID пользователя—исполнителя задачи'),
    ...
    op.create_table('comments',
        ...
        sa.Column('created_at', sa.DateTime(), nullable=False, comment='Дата и время создания комментария'),
        sa.Column('task_id', sa.Integer(), nullable=False, comment='ID задачи, к которой относится комментарий'),
        sa.Column('author_id', sa.Integer(), nullable=False, comment='ID пользователя-автора комментария'),
    ...
    op.create_table('evaluations',
        ...
        sa.Column('created_at', sa.DateTime(), nullable=False, comment='Дата и время создания оценки'),
        sa.Column('task_id', sa.Integer(), nullable=False, comment='ID задачи, для которой выставлена оценка'),
        sa.Column('evaluator_id', sa.Integer(), nullable=False, comment='ID пользователя, который выставил оценку'),
